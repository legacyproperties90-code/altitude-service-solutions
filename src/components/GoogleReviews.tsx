  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* CTA to real Google profile */}
        <div className="max-w-xl mx-auto text-center bg-gray-50 rounded-2xl p-10 border border-gray-100">
          <div className="flex justify-center gap-0.5 mb-4">
            {[1,2,3,4,5].map((i) => <Star key={i} size={22} className="fill-yellow-400 text-yellow-400" />)}
          </div>
